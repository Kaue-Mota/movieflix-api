  ...
  */
  ...
  export type MovieGetPayload<S extends boolean | null | undefined | MovieArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'language' ? LanguageGetPayload<S['include'][P]> | null :  never
  } 
    : S extends { select: any } & (MovieArgs | MovieFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'genre' ? GenreGetPayload<S['select'][P]> | null :
        P extends 'language' ? LanguageGetPayload<S['select'][P]> | null :  P extends keyof Movie ? Movie[P] : never
  } 
      : Movie
  ...
  export class Prisma__MovieClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    language<T extends LanguageArgs= {}>(args?: Subset<T, LanguageArgs>): Prisma__LanguageClient<LanguageGetPayload<T> | Null>;
  ...
  export type MovieWhereInput = {
    ...
    language?: XOR<LanguageRelationFilter, LanguageWhereInput> | null
  }
  ...
  export type MovieCreateNestedManyWithoutLanguageInput = {
    create?: XOR<Enumerable<MovieCreateWithoutLanguageInput>, Enumerable<MovieUncheckedCreateWithoutLanguageInput>>
  ...
  export type MovieUpdateManyWithoutLanguageNestedInput = {
    ...
    updateMany?: Enumerable<MovieUpdateManyWithWhereWithoutLanguageInput>
    deleteMany?: Enumerable<MovieScalarWhereInput>
  }
  ...
  export type MovieCreateManyLanguageInputEnvelope = {
    data: Enumerable<MovieCreateManyLanguageInput>
    skipDuplicates?: boolean
  }
